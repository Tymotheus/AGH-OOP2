public class Lab5 {
    ...
    // public static void printStaff(Man[]peopleTab){
    //     for (int i=0; i<peopleTab.length; i++){
    //         System.out.println(String.format("%s: %s" , peopleTab[i].getClass().getSimpleName(), peopleTab[i].toString()) );
    //     }}
    public static void main(String[] args) {
        Man[] staff = new Man[6];
        String name = "Tymcio";
        String surname = "Ciesielski";
